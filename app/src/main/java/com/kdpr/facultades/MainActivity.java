...
import com.kdpr.facultades.ml.MariaFacultad;
...
public class MainActivity extends AppCompatActivity
   ...
   /* Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
    ...
    public void PersonalizedModel(View v) {
        try {
            MariaFacultad model = MariaFacultad.newInstance(getApplicationContext());
            TensorImage image = TensorImage.fromBitmap(mSelectedImage);

            MariaFacultad.Outputs outputs = model.process(image);
